...
async def radar_page(request: Request):
    try:
        ...
        mock_tenders = [
            {"id": "0373100000124000055", "title": "Аэрофотосъемка (ЛЭП 15км)", "price": 145000, "region": "Свердловская обл.", "link": "#", "is_vip": False},
            {"id": "32413480112", "title": "Мониторинг теплосетей с БПЛА", "price": 380000, "region": "Новосибирск", "link": "#", "is_vip": True},
            {"id": "0173200001424000112", "title": "Кадастровые работы (RTK)", "price": 550000, "region": "Московская обл.", "link": "#", "is_vip": False}
        ]
